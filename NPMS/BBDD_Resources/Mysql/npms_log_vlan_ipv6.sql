...
--
-- Table structure for table `log_vlan_ipv6`
--

DROP TABLE IF EXISTS `log_vlan_ipv6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_vlan_ipv6` (
  ...
  `Initial_Range` varchar(150) DEFAULT NULL,
  `Final_Range` varchar(150) DEFAULT NULL,
...
--
-- Dumping data for table `log_vlan_ipv6`
--

LOCK TABLES `log_vlan_ipv6` WRITE;
/*!40000 ALTER TABLE `log_vlan_ipv6` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_vlan_ipv6` ENABLE KEYS */;
UNLOCK TABLES;
