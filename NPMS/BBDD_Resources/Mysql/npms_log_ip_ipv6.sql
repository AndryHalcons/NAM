...
--
-- Table structure for table `log_ip_ipv6`
--

DROP TABLE IF EXISTS `log_ip_ipv6`;
...
--
-- Dumping data for table `log_ip_ipv6`
--

LOCK TABLES `log_ip_ipv6` WRITE;
/*!40000 ALTER TABLE `log_ip_ipv6` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_ip_ipv6` ENABLE KEYS */;
UNLOCK TABLES;
