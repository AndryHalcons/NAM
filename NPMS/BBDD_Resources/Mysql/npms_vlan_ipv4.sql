...
--
-- Table structure for table `vlan_ipv4`
--

DROP TABLE IF EXISTS `vlan_ipv4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vlan_ipv4` (
...
--
-- Dumping data for table `vlan_ipv4`
--

LOCK TABLES `vlan_ipv4` WRITE;
/*!40000 ALTER TABLE `vlan_ipv4` DISABLE KEYS */;
/*!40000 ALTER TABLE `vlan_ipv4` ENABLE KEYS */;
UNLOCK TABLES;
