...
CREATE TABLE `log_inventory` (
  ...
  `CONTACT_PROPERTY` varchar(60) DEFAULT NULL,
  `ADITIONAL_INFO` varchar(60) DEFAULT NULL,
  `PORTS` varchar(60) DEFAULT NULL,
...
-- Dump completed on 2020-03-21 18:28:02
