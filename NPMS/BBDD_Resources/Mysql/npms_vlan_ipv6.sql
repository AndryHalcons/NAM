...
--
-- Table structure for table `vlan_ipv6`
--

DROP TABLE IF EXISTS `vlan_ipv6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vlan_ipv6` (
  ...
  UNIQUE KEY `Vlan_UNIQUE` (`Vlan`),
  UNIQUE KEY `Network_UNIQUE` (`Network`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `vlan_ipv6`
--

LOCK TABLES `vlan_ipv6` WRITE;
/*!40000 ALTER TABLE `vlan_ipv6` DISABLE KEYS */;
/*!40000 ALTER TABLE `vlan_ipv6` ENABLE KEYS */;
UNLOCK TABLES;
